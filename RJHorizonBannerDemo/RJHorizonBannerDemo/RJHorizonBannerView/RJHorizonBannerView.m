...
@implementation RJHorizonBannerView
...
- (void)scrollEvent {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        [weakself.scrollView setContentOffset:CGPointMake(_scrollView.bounds.size.width * 2, 0)];
...
//        [imageView sd_setImageWithURL:_imagesArray[count] placeholderImage:nil];
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            NSData * data = [NSData dataWithContentsOfURL:weakself.imagesArray[count]];
        ...
        [imageView setImage:[UIImage imageNamed:_imagesArray[count]]];
    }
}
...
- (UIScrollView *)getScrollView {
    if (!_scrollView) {
        ...
        [_scrollView setContentSize:CGSizeMake(_scrollView.bounds.size.width * 3, 0)];
        [_scrollView setContentOffset:CGPointMake(_scrollView.bounds.size.width, 0)];
